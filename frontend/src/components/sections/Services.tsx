  ...
  return (
    <section id="services" aria-labelledby="services-title" data-testid="services-section">
      <Reveal className="mx-auto max-w-6xl px-6 py-24 md:px-10 md:py-36">
        <SectionHeader index="01" kicker="Services" title="What I build" titleId="services-title" />
        {services.map((service) => (
          ...
          >
            ...
            <div>
              <p className="max-w-md text-sm text-mute md:text-base">{service.description}</p>
              <ul className="mt-5 flex flex-wrap gap-2" aria-label={`${service.title} technologies`}>
